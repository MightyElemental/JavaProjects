...
public class TextBox extends GUIObject {
	...
	public void draw(Graphics g) {
		...
		g.draw(this);
		g.drawString(getText(), getCenterX() - Munchkin.font.getWidth(getText()) / 2, getCenterY() - Munchkin.font.getHeight() / 2);
	}
	...
	/*
	 * (non-Javadoc)
	 * @see net.iridgames.munchkin.gui.GUIObject#setTextColor(org.newdawn.slick.Color)
	 */
	@Override
