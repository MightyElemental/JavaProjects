...
public class SkypeOS implements ChatMessageListener, ChatMessageEditListener {
	...
	public static String[] bannedWords = { getSFB(new Byte[] { 102, 117, 99, 107 }), getSFB(new Byte[] { 115, 104, 105, 116 }), "(finger)",
		...
		getSFB(new Byte[] { 97, 114, 115, 101 }), getSFB(new Byte[] { 114, 105, 109, 32, 106, 111, 98 }),
		getSFB(new Byte[] { 100, 105, 99, 116, 97, 116, 111, 114, 115, 104, 105, 112 }) };
	...
	public void conditionMessage(String message) throws SkypeException {
		...
		// chat.send(
		// "[Skype] James is currently unavailable, please talk to his account directly if you are trying to contact
		// him, thanks.");
		// }
