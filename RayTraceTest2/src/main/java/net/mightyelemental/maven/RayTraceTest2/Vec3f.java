...
public class Vec3f {
	...
	public Vec3f sum(Vec3f v) { return new Vec3f( v.x + x, v.y + y, v.z + z ); }

	public void sumSave(Vec3f v) { x += v.x; y += v.y; z += v.z; }

	public Vec3f getUnitVec() { float l = getLength(); return new Vec3f( x / l, y / l, z / l ); }
	...
	public Vec3f vecTo(Vec3f v) { return new Vec3f( v.x - x, v.y - y, v.z - z ); }
	...
	public Vec3f mul(float s) { return new Vec3f( x * s, y * s, z * s ); }

	public Vec3f getNegative() { return new Vec3f( -x, -y, -z ); }

	public Vec3f negate() { this.x = -x; this.y = -y; this.z = -z; return this; }

	public Vec3f sum(float s) { return new Vec3f( x + s, y + s, z + s ); }

	public Vec3f mul(Vec3f v) { return new Vec3f( x * v.x, y * v.y, z * v.z ); }

	public static Vec3f origin() { return new Vec3f( 0, 0, 0 ); }

	public final Vec3f cross(Vec3f B) {
		return new Vec3f( y * B.z - z * B.y, z * B.x - x * B.z, x * B.y - y * B.x );
	}

	public float dot(float f, float g, float h) { return dot( new Vec3f( f, g, h ) ); }
