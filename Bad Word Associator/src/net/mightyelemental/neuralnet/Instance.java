...
public class Instance implements Serializable {// TODO: training data. Strength of response and compared to the rest of
	...
	public double getFitness() {
		...
		// this.word = word;
		double val = result();
		int valAdj = (int) Math.floor(val * 5);
		double diff = Math.abs(valAdj - val * 5);
		WordManager.types t = WordManager.types.values()[valAdj];
		boolean correct = WordManager.getWord(word) == t;
		// }
		return correct ? 10000 - 2000 * diff : -2000;
	}
